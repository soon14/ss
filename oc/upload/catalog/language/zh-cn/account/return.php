...
$_['text_account']       = '账户';
$_['text_return']        = '退货信息';
$_['text_return_detail'] = '退货详细信息';
$_['text_description']   = '<p>请完整填写下表，并获取RMA号。</p>';
$_['text_order']         = '订单信息';
$_['text_product']       = '商品信息 &amp; 退换原因';
$_['text_reason']        = '退货原因';
$_['text_message']       = '<p>感谢您提交您的退货请求。您的请求已向相关部门进行处理。</p><p>我们将通过电子邮件通知您的请求状态。</p>';
$_['text_return_id']     = '退换号';
$_['text_order_id']      = '订单号';
$_['text_date_ordered']  = '订单日期';
$_['text_status']        = '状态';
$_['text_date_added']    = '申请日期';
$_['text_comment']       = '退换备注';
$_['text_history']       = '退换记录';
...
$_['entry_quantity']     = '数量';
$_['entry_reason']       = '退换原因';
$_['entry_opened']       = '已打开包装';
$_['entry_fault_detail'] = '详细描述';

// Error
$_['text_error']         = '找不到您的退換单号！';
$_['error_order_id']     = '请输入订单号。';
$_['error_firstname']    = '名字必须在 1 至 32 字符之间！';
$_['error_email']        = '无效的邮箱地址。';
$_['error_telephone']    = '电话号码必须为 2 至 32 字符。';
$_['error_product']      = '商品名称必须是大于 3 且小于 255 个字符！';
$_['error_model']        = '商品型号必须大于 3 和少于 64 个字符！';
