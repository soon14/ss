...
class ControllerAccountEdit extends Controller {
	...
	protected function validate() {
		...
		if ($this->request->post['email'] && (($this->customer->getEmail() != $this->request->post['email']) && $this->model_account_customer->getTotalCustomersByEmail($this->request->post['email']))) {
		...
		if ($this->request->post['telephone'] && (($this->customer->getTelephone() != $this->request->post['telephone']) && $this->model_account_customer->getTotalCustomersByTelephone($this->request->post['telephone']))) {
