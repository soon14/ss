...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_select_country'])) {
		    $data['config_select_country'] = $this->request->post['config_select_country'];
		} else {
		    $data['config_select_country'] = $this->config->get('config_select_country');
		}
