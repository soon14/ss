...
$_['entry_date_added_start']           = '订单生成日期 (开始)';
$_['entry_date_added_end']             = '订单生成日期 (结束)';

// Help
$_['help_override']                    = '反欺诈扩展可能造成订单状态覆盖，导致订单状态更改失败。';

// Error
$_['error_warning']                    = '错误：请检查表单错误！';
$_['error_permission']                 = '错误：您没有权限修改订单！';
$_['error_action']                     = '错误：不能完成操作！';
